...
const styles = {
  "pages/index.vue": () => import('./index-styles.rFZN2m1m.mjs').then(interopDefault),
  "pages/index.vue?vue&type=style&index=0&lang.css": () => import('./index-styles.rFZN2m1m.mjs').then(interopDefault),
