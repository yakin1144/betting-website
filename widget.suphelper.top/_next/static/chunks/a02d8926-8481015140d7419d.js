...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
  [307],
  {
    39084: (e, t, n) => {
      ...
      function y(e) {
        ((!e.__d && (e.__d = !0) && l.push(e) && !C.__r++) ||
          d !== s.debounceRendering) &&
          ((d = s.debounceRendering) || c)(C);
      }
      function C() {
        for (var e; (C.__r = l.length); )
      ...
      function x(e, t, n, i, o, r, a, l, c, d) {
        ...
        for (n.__k = [], p = 0; p < t.length; p++)
          if (
            ...
            P(e, v, (g = g || u), o, r, a, l, c, d),
              (k = v.__e),
              (f = v.ref) &&
                g.ref != f &&
                (C || (C = []),
                g.ref && C.push(g.ref, null, v),
                C.push(f, v.__c || k, v)),
              null != k
                ? (null == y && (y = k),
                ...
                : c && g.__e == c && c.parentNode != e && (c = w(g));
          }
        for (n.__e = y, p = S; p--; )
          null != x[p] &&
            ...
            (function e(t, n, i) {
              ...
              if (
                ...
                (o = t.ref) &&
                  ((o.current && o.current !== t.__e) || R(o, null, n)),
                null != (o = t.__c))
              ) {
              ...
              if ((o = t.__k))
                for (r = 0; r < o.length; r++)
                  o[r] && e(o[r], n, "function" != typeof t.type);
              i || null == t.__e || _(t.__e), (t.__e = t.__d = void 0);
            })(x[p], x[p]));
        if (C) for (p = 0; p < C.length; p++) R(C[p], C[++p], C[++p]);
      }
      function S(e, t) {
        return (
          (t = t || []),
      ...
      function j(e, t, n, i, o, r) {
        ...
        if (void 0 !== t.__d) (s = t.__d), (t.__d = void 0);
          ...
          e: if (null == r || r.parentNode !== e) e.appendChild(o), (s = null);
          else {
            for (a = r, l = 0; (a = a.nextSibling) && l < i.length; l += 2)
              if (a == o) break e;
      ...
      function M(e, t, n, i, o) {
        ...
        e: if ("style" === t)
          if ("string" == typeof n) e.style.cssText = n;
            ...
            if (n) for (t in n) (i && n[t] === i[t]) || z(e.style, t, n[t]);
          }
        else if ("o" === t[0] && "n" === t[1])
          (r = t !== (t = t.replace(/Capture$/, ""))),
            ...
            (e.l[t + r] = n),
            n
              ? i || e.addEventListener(t, r ? E : L, r)
              : e.removeEventListener(t, r ? E : L, r);
      ...
      function P(e, t, n, i, o, a, l, c, d) {
        ...
        try {
          e: if ("function" == typeof E) {
            if (
              ((S = t.props),
              (j = (h = E.contextType) && i[h.__c]),
              (z = h ? (j ? j.props.value : h.__) : i),
              n.__c
                ? (C = (p = t.__c = n.__c).__ = p.__E)
              ...
              null != E.getDerivedStateFromProps &&
                ...
                f(p.__s, E.getDerivedStateFromProps(S, p.__s))),
              (m = p.props),
              (v = p.state),
              g)
            )
              ...
              if (
                (null == E.getDerivedStateFromProps &&
                  ...
                  p.componentWillReceiveProps(S, z),
                (!p.__e &&
                  null != p.shouldComponentUpdate &&
                  !1 === p.shouldComponentUpdate(S, p.__s, z)) ||
                  t.__v === n.__v)
              ) {
                (p.props = S),
                  (p.state = p.__s),
              ...
              null != p.componentWillUpdate &&
                p.componentWillUpdate(S, p.__s, z),
            ...
            (p.context = z),
              ...
              null != p.getChildContext &&
                (i = f(f({}, i), p.getChildContext())),
              g ||
                null == p.getSnapshotBeforeUpdate ||
                (y = p.getSnapshotBeforeUpdate(m, v)),
              (L =
                null != h && h.type === b && null == h.key
                  ? h.props.children
                  : h),
              x(e, Array.isArray(L) ? L : [L], t, n, i, o, a, l, c, d),
              (p.base = t.__e),
              (t.__h = null),
              p.__h.length && l.push(p),
              C && (p.__E = p.__ = null),
            ...
            null == a && t.__v === n.__v
              ...
              : (t.__e = (function (e, t, n, i, o, s, a, l) {
                  var c,
                    d,
                    h,
                    p = n.props,
                  ...
                  if (null === g)
                    p === f || (l && e.data === f) || (e.data = f);
                  else {
                    if (
                      ((s = s && r.call(e.childNodes)),
                      (d = (p = n.props || u).dangerouslySetInnerHTML),
                    ...
                    l ||
                      ("value" in f &&
                        ...
                        (m !== p.value ||
                          m !== e.value ||
                          ("progress" === g && !m)) &&
                        M(e, "value", m, p.value, !1),
                      "checked" in f &&
                        void 0 !== (m = f.checked) &&
                        m !== e.checked &&
                        M(e, "checked", m, p.checked, !1));
                  }
                  return e;
                })(n.__e, t, n, i, o, a, l, d));
          (h = s.diffed) && h(t);
      ...
      var U = {
        latestVersion: function () {
          for (let { v: e, emoji: t } of V) if ($(t)) return e;
        },
      ...
      var q = {
          ...
          get: function ({ maxFrequentRows: e, perLine: t }) {
            if (!e) return [];
            W || (W = I.get("frequently"));
            let n = [];
            if (!W) {
              for (let e in ((W = {}), N.slice(0, t))) {
                let i = N[e];
                (W[i] = t - e), n.push(i);
              }
              return n;
            ...
            if (
              ...
              let e = n.slice(i);
              for (let t of ((n = n.slice(0, i)), e)) t != o && delete W[t];
              o &&
                -1 == n.indexOf(o) &&
                (delete W[n[n.length - 1]], n.splice(-1, 1, o)),
                I.set("frequently", W);
            }
            return n;
          },
      ...
      async function ei(e) {
        et = !0;
        let { emojiVersion: t, set: n, locale: o } = e;
        if (
          (t || (t = G.emojiVersion.value),
          n || (n = G.set.value),
          o || (o = G.locale.value),
          J)
        )
          J.categories = J.categories.filter((e) => !e.name);
        else {
          for (let i in (((J =
          ...
          (J.natives = {}),
          J.categories.unshift({ id: "frequent", emojis: [] }),
          J.aliases)) {
            let e = J.aliases[i],
              t = J.emojis[e];
            t && (t.aliases || (t.aliases = []), t.aliases.push(i));
          }
          J.originalCategories = J.categories;
        }
        if (
          ((X =
            ...
            ("en" == o
              ? i(K)
              : await Z(
                  `https://cdn.jsdelivr.net/npm/@emoji-mart/data@latest/i18n/${o}.json`
                ))),
          e.custom)
        )
          for (let t in e.custom) {
            ...
            if (n.emojis && n.emojis.length)
              for (let e of (n.id || (n.id = `custom_${t + 1}`),
              n.name || (n.name = X.categories.custom),
              i && !n.icon && (n.target = i.target || i),
              J.categories.push(n),
              n.emojis))
                J.emojis[e.id] = e;
          }
        e.categories &&
          (J.categories = J.originalCategories
            .filter((t) => -1 != e.categories.indexOf(t.id))
            .sort(
              (t, n) => e.categories.indexOf(t.id) - e.categories.indexOf(n.id)
            ));
        let r = null,
          s = null;
        "native" == n &&
          ((r = U.latestVersion()),
          (s = e.noCountryFlags || U.noCountryFlags()));
        let a = J.categories.length,
          l = !1;
        for (; a--; ) {
          let t = J.categories[a];
          if ("frequent" == t.id) {
            let { maxFrequentRows: n, perLine: i } = e;
            (n = n >= 0 ? n : G.maxFrequentRows.value),
              i || (i = G.perLine.value),
              (t.emojis = q.get({ maxFrequentRows: n, perLine: i }));
          }
          if (!t.emojis || !t.emojis.length) {
            J.categories.splice(a, 1);
            continue;
          }
          let { categoryIcons: n } = e;
          if (n) {
            let e = n[t.id];
            e && !t.icon && (t.icon = e);
          }
          ...
          for (; i--; ) {
            ...
            if (
              !o ||
              (e.exceptEmojis && e.exceptEmojis.includes(o.id)) ||
              (r && o.version > r) ||
              (s && "flags" == t.id && !el.includes(o.id))
            ) {
              a();
              continue;
            }
            if (!o.search) {
              if (
                ...
                for (let e of o.emoticons)
                  J.emoticons[e] || (J.emoticons[e] = o.id);
              let e = 0;
              for (let t of o.skins) {
                if (!t) continue;
                e++;
                let { native: n } = t;
                n && ((J.natives[n] = o.id), (o.search += `,${n}`));
      ...
      function er(e, t, n, i) {
        ...
        return (
          o &&
            (null != r &&
              o.value &&
              typeof o.value != typeof r &&
              (r =
                "boolean" == typeof o.value
                  ? "false" != r
                  : o.value.constructor(r)),
            o.transform && r && (r = o.transform(r)),
            (null == r || (o.choices && -1 == o.choices.indexOf(r))) &&
              (r = o.value)),
          r
        );
      }
      let es = null;
      var ea = {
        search: async function (e, { maxResults: t, caller: n } = {}) {
          let i, o;
          if (!e || !e.trim().length) return null;
          t || (t = 90), await en(null, { caller: n || "SearchIndex.search" });
          let r = e
            .toLowerCase()
            .replace(/(\w)-/, "$1 ")
            .split(/[\s|,]+/)
          ...
          if (!r.length) return;
          let s = es || (es = Object.values(J.emojis));
          for (let e of r) {
            if (!s.length) break;
            for (let t of ((i = []), (o = {}), s)) {
        ...
        get: function (e) {
          return e.id
            ? e
            : J.emojis[e] || J.emojis[J.aliases[e]] || J.emojis[J.natives[e]];
        },
        reset: function () {
          es = null;
        },
        ...
        categories: {
          ...
          frequent: {
            outline: T("svg", {
              ...
              viewBox: "0 0 24 24",
              children: [
                T("path", { d: "M13 4h-2l-.001 7H9v2h2v2h2v-2h4v-2h-4z" }),
                T("path", {
          ...
          children: r
            ...
            : T("span", {
                style: {
                  ...
                  backgroundSize: `${100 * J.sheet.cols}% ${
                    100 * J.sheet.rows
                  }%`,
                  backgroundPosition: `${(100 / (J.sheet.cols - 1)) * o.x}% ${
                    (100 / (J.sheet.rows - 1)) * o.y
                  }%`,
                },
              }),
        });
      ...
      class ep extends eh {
        ...
        attributeChangedCallback(e, t, n) {
          ...
          let i = er(e, { [e]: n }, this.constructor.Props, this);
          this.component.componentWillReceiveProps
            ? this.component.componentWillReceiveProps({ [e]: i })
      ...
      class eg extends ep {
        async connectedCallback() {
          let e = eo(this.props, e_, this);
          (e.element = this),
            (e.ref = (e) => {
              this.component = e;
            }),
            await en(),
            this.disconnected || H(T(eu, { ...e }), this);
        }
        constructor(e) {
          super(e);
        }
      ...
      o(eg, "Props", e_),
        "undefined" == typeof customElements ||
          ...
          customElements.define("em-emoji", eg);
      var em,
        ev,
        eb,
        ek = [],
      ...
      function ej() {
        ...
        for (
          ...
          if (e.__P)
            try {
              e.__H.__h.forEach(eM), e.__H.__h.forEach(eL), (e.__H.__h = []);
            } catch (t) {
      ...
      (s.__b = function (e) {
        ...
        (s.__r = function (e) {
          ey && ey(e), (em = 0);
          var t = (ev = e.__c).__H;
          t && (t.__h.forEach(eM), t.__h.forEach(eL), (t.__h = []));
        }),
        (s.diffed = function (e) {
          eC && eC(e);
          var t = e.__c;
          t &&
            t.__H &&
            t.__H.__h.length &&
            ((1 !== ek.push(t) && eb === s.requestAnimationFrame) ||
              (
                (eb = s.requestAnimationFrame) ||
                function (e) {
                  var t,
                    n = function () {
                      clearTimeout(i),
                        ez && cancelAnimationFrame(t),
                        setTimeout(e);
                    },
                    i = setTimeout(n, 100);
                  ez && (t = requestAnimationFrame(n));
                }
              )(ej)),
            (ev = null);
        }),
      ...
      var ez = "function" == typeof requestAnimationFrame;
      function eM(e) {
        var t = ev,
          n = e.__c;
        "function" == typeof n && ((e.__c = void 0), n()), (ev = t);
      }
      function eL(e) {
        var t = ev;
        (e.__c = e.__()), (ev = t);
      ...
      ((eP.prototype = new k()).isPureReactComponent = !0),
        (eP.prototype.shouldComponentUpdate = function (e, t) {
      ...
      (s.unmount = function (e) {
        ...
        ((eH.prototype = new k()).__c = function (e, t) {
          var n = t.__c,
            i = this;
          ...
          var a = function () {
              if (!--i.__u) {
                ...
                for (i.setState({ __e: (i.__b = null) }); (e = i.t.pop()); )
                  e.forceUpdate();
              }
            },
            l = !0 === t.__h;
          i.__u++ || l || i.setState({ __e: (i.__b = i.__v.__k[0]) }),
            e.then(s, s);
        }),
        (eH.prototype.componentWillUnmount = function () {
          this.t = [];
        }),
        (eH.prototype.render = function (e, t) {
          if (this.__b) {
            if (this.__v.__k) {
          ...
          return (
            o && (o.__h = null), [g(b, null, t.__e ? null : e.children), o]
          );
        });
      ...
      ((eT.prototype = new k()).__e = function (e) {
        var t = this,
          n = eA(t.__v),
          i = t.o.get(e);
        return (
          ...
          function (o) {
            var r = function () {
              t.props.revealOrder ? (i.push(o), eI(t, e, i)) : o();
            };
            n ? n(r) : r();
          }
        );
      ...
      s.event = function (e) {
        return (
          eF && (e = eF(e)),
          (e.persist = eU),
          (e.isPropagationStopped = eN),
          (e.isDefaultPrevented = eW),
          (e.nativeEvent = e)
        );
      };
      var eq = {
      ...
      s.vnode = function (e) {
        ...
        if ("string" == typeof t) {
          ...
          for (var r in ((i = {}), n)) {
            var s,
              a = n[r];
            (e$ && "children" === r && "noscript" === t) ||
              ("value" === r && "defaultValue" in n && null == a) ||
              ("defaultValue" === r && "value" in n && null == n.value
                ...
                ? (r = "ondblclick")
                : /^onchange(textarea|input)/i.test(r + t) &&
                  ((s = n.type),
                  !(
          ...
          "select" == t &&
            ...
            (i.value = S(n.children).forEach(function (e) {
            ...
            (e.props = i),
            n.class != n.className &&
              ((eq.enumerable = "className" in n),
              null != n.className && (i.class = n.className),
              Object.defineProperty(i, "className", eq));
        }
        (e.$$typeof = eO), eK && eK(e);
      };
      var eG = s.__r;
      ...
      let eX = { light: "outline", dark: "solid" };
      class eJ extends eP {
        renderIcon(e) {
          let { icon: t } = e;
          if (t) {
            ...
            if (t.src) return T("img", { src: t.src });
          }
          let n = ed.categories[e.id] || ed.categories.custom;
          return (
            n[
            ...
            children: T("div", {
              ...
              children: [
                this.categories.map((t, n) => {
                  let i = t.name || X.categories[t.id],
        ...
        constructor() {
          super(),
            (this.categories = J.categories.filter((e) => !e.target)),
      ...
      let eZ = { rowsPerRender: 10 };
      class eQ extends k {
        getInitialState(e = this.props) {
          return {
            skin: I.get("skin") || e.skin,
            theme: this.initTheme(e.theme),
          };
        }
        componentWillMount() {
          (this.dir = X.rtl ? "rtl" : "ltr"),
            (this.refs = {
              menu: v(),
              navigation: v(),
              scroll: v(),
        ...
        componentWillReceiveProps(e) {
          for (let t in (this.nextState || (this.nextState = {}), e))
            this.nextState[t] = e[t];
          clearTimeout(this.nextStateTimer),
            (this.nextStateTimer = setTimeout(() => {
              let e = !1;
              for (let t in this.nextState)
                (this.props[t] = this.nextState[t]),
                  ("custom" === t || "categories" === t) && (e = !0);
        ...
        unobserve({ except: e = [] } = {}) {
          for (let t of (Array.isArray(e) || (e = [e]), this.observers))
        ...
        initGrid() {
          ...
          let t = J.categories.map((e) => e.id).join(",");
          this.navKey &&
            this.navKey != t &&
          ...
          let n = (e, t) => {
            ...
            let i = this.grid.length - 1,
              o = i % eZ.rowsPerRender ? {} : v();
            return (
              (o.index = i), (o.posinset = this.grid.setsize + 1), e.push(o), n
            );
          };
          for (let t of e) {
            let e = [],
            ...
            for (let o of t.emojis)
              i.length == this.getPerLine() && (i = n(e, t)),
                (this.grid.setsize += 1),
                i.push(o);
            this.refs.categories.set(t.id, { root: v(), rows: e });
          }
        }
        initTheme(e) {
          if ("auto" != e) return e;
        ...
        initDynamicPerLine(e = this.props) {
          ...
          let { element: t, emojiButtonSize: n } = e,
            i = () => {
        ...
        observeCategories() {
          ...
          let t = new Map(),
            ...
            i = new IntersectionObserver(
              ...
              { root: this.refs.scroll.current, threshold: [0, 1] }
            );
          ...
          let e = { ...this.state.visibleRows },
            t = new IntersectionObserver(
              ...
              },
              {
                ...
                rootMargin: `${
                  this.props.emojiButtonSize * (eZ.rowsPerRender + 5)
                }px 0px ${this.props.emojiButtonSize * eZ.rowsPerRender}px`,
              }
            );
        ...
        navigate({ e: e, input: t, left: n, right: i, up: o, down: r }) {
          ...
          this.setState({ pos: c, keyboard: !0 }, () => {
            this.scrollTo({ row: c[0] });
          });
        }
        scrollTo({ categoryId: e, row: t }) {
          ...
          let i = this.refs.scroll.current,
            ...
            r = 0;
          if (
            (t >= 0 && (e = n[t].__categoryId),
            e &&
              (r =
                (
                  this.refs[e] || this.refs.categories.get(e).root
        ...
        handleEmojiClick({ e: e, emoji: t, pos: n }) {
          if (
            this.props.onEmojiSelect &&
            (!t && n && (t = this.getEmojiByPos(n)), t)
          ) {
            let n = (function (e, { skinIndex: t = 0 } = {}) {
              ...
              return (
                e.skins.length > 1 && (i.skin = t + 1),
                n.src && (i.src = n.src),
                e.aliases && e.aliases.length && (i.aliases = e.aliases),
                e.emoticons &&
                  e.emoticons.length &&
                  (i.emoticons = e.emoticons),
                i
              );
            })(t, { skinIndex: this.state.skin - 1 });
            this.props.maxFrequentRows && q.add(n, this.props),
              this.props.onEmojiSelect(n, e);
          }
        }
        closeSkins() {
          this.state.showSkins &&
                        ...
                        ? T("div", {
                            ...
                            children: [
                              T("div", {
                                ...
                                children: e ? e.name : X.search_no_results_1,
                              }),
                              T("div", {
                                class: "preview-subtitle ellipsis color-c",
                                children: e
                                  ? e.skins[0].shortcodes
                                  : X.search_no_results_2,
                              }),
                            ],
                          })
                        : T("div", {
        ...
        renderEmojiButton(e, { pos: t, posinset: n, grid: i }) {
          var o;
                    ...
                    style: {
                      ...
                      backgroundColor: this.props.emojiButtonColors
                        ? this.props.emojiButtonColors[
                            (n - 1) % this.props.emojiButtonColors.length
                          ]
                        : void 0,
                    },
                  }),
        ...
        renderCategories() {
          ...
          return T("div", {
            ...
            children: e.map((e) => {
              let { root: t, rows: i } = this.refs.categories.get(e.id);
              return T("div", {
                ...
                children: [
                  T("div", {
                    class: `sticky padding-small align-${this.dir[0]}`,
                    children: e.name || X.categories[e.id],
                  }),
                  T("div", {
                    class: "relative",
                    style: { height: i.length * this.props.emojiButtonSize },
                    children: i.map((t, i) => {
                      let o = t.index - (t.index % eZ.rowsPerRender),
                      ...
                      return (
                        l.length < n && l.push(...Array(n - l.length)),
                        T(
                          "div",
                          {
                            "data-index": t.index,
          ...
          return "none" == this.props.skinTonePosition
            ...
            : T("div", {
                ...
                children: T("button", {
                  ...
                  "aria-label": X.skins.choose,
                  title: X.skins.choose,
                ...
                return T("div", {
                  children: [
                    ...
                    T("button", {
                      ...
                      children: [
                        T("span", { class: `skin-tone skin-tone-${t}` }),
                        T("span", {
        ...
        constructor(e) {
          super(),
            ...
            o(this, "handleSearchInput", async () => {
              ...
              if (!n)
                return this.setState({ searchResults: n, pos: [-1, -1] }, i);
              let o = e.selectionStart == e.value.length ? [0, 0] : [-1, -1],
                r = [];
              r.setsize = n.length;
              let s = null;
              for (let e of n)
                (r.length && s.length != this.getPerLine()) ||
                  (((s = []).__categoryId = "search"),
                  (s.__index = r.length),
                  r.push(s)),
                  s.push(e);
              this.ignoreMouse(),
                this.setState({ searchResults: r, pos: o }, i);
            }),
            ...
            o(this, "handleCategoryClick", ({ category: e, i: t }) => {
              this.scrollTo(0 == t ? { row: -1 } : { categoryId: e.id });
            }),
            o(this, "openSkins", (e) => {
      ...
      class e1 extends ef {
        async connectedCallback() {
          ...
          (e.element = this),
            ...
            await en(e),
            this.disconnected || H(T(eQ, { ...e }), this.shadowRoot);
        }
        constructor(e) {
          super(e, { styles: i(e2) });
        }
      ...
      o(e1, "Props", G),
        "undefined" == typeof customElements ||
          ...
          customElements.define("em-emoji-picker", e1);
      var e2 = {};
      e2 =
