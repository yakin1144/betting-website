...
export default {
  "pages/index.vue": () => import('./_nuxt/index-styles.rFZN2m1m.mjs').then(interopDefault),
  "pages/index.vue?vue&type=style&index=0&lang.css": () => import('./_nuxt/index-styles.rFZN2m1m.mjs').then(interopDefault),
