  ...
  [46637997],
  {
    46637997: (e, n, r) => {
      e.exports = (function e(n, r, t) {
        ...
        for (var i = void 0, a = 0; a < t.length; a++) o(t[a]);
        return o;
      })(
        {
          1: [
          ...
          2: [
            function (e, n, r) {
              ...
              function b(e) {
                ...
                for (
                  var a = new Array(r), u = 0, c = -1, f = new this(o);
                  ++c < r;
              ...
              function m(e) {
                ...
                var r = e.length,
                  t = !1;
                if (!r) return this.resolve([]);
                for (var a = -1, u = new this(o); ++a < r; ) c(e[a]);
                return u;
                function c(e) {
                  n.resolve(e).then(
                    function (e) {
              ...
              (n.exports = f),
                ...
                (f.prototype.then = function (e, n) {
                  ...
                  return (
                    this.state !== c
                      ? l(r, this.state === u ? e : n, this.outcome)
                      : this.queue.push(new s(r, e, n)),
                    r
                  );
                }),
                ...
                (i.reject = function (e, n) {
                  ...
                  for (var r = -1, t = e.queue.length; ++r < t; )
                    e.queue[r].callRejected(n);
                  return e;
                }),
                (f.resolve = y),
                (f.reject = p),
          ...
          4: [
            function (e, n, r) {
                    ...
                    (i.onupgradeneeded = function (n) {
                      ...
                      try {
                        r.createObjectStore(e.storeName),
                          n.oldVersion <= 1 && r.createObjectStore(h);
                      } catch (t) {
              ...
              function C(e) {
                S(e);
                for (
                  var n = p[e.name], r = n.forages, t = 0;
                  t < r.length;
                  t++
                ) {
                  var o = r[t];
              ...
              function L(e) {
                ...
                return f
                  .all(i)
                  .then(function () {
                    return (r.db = o.db), R(r);
                  })
                  .then(function (e) {
                    return (
                      (r.db = e), O(r, n._defaultConfig.version) ? A(r) : e
                    );
                  })
                  .then(function (e) {
              ...
              function M(e, n) {
                var r = this;
                e = d(e);
                var t = new f(function (n, t) {
                  r.ready()
                    .then(function () {
                      T(r._dbInfo, m, function (o, i) {
                        if (o) return t(o);
                        try {
              ...
              function P(e, n, r) {
                var t = this;
                e = d(e);
                var o = new f(function (r, o) {
                  var i;
                  t.ready()
                    .then(function () {
                      return (
                        (i = t._dbInfo),
                        "[object Blob]" === b.call(n)
                          ? I(i.db).then(function (e) {
                              return e ? n : D(n);
                            })
                          : n
                      );
              ...
              function q(e) {
                var n = this,
                  r = new f(function (e, r) {
                    n.ready()
                      .then(function () {
                        T(n._dbInfo, g, function (t, o) {
                          if (t) return r(t);
                          try {
              ...
              function Q(e, n) {
                ...
                if (e.name) {
                  ...
                  t = e.storeName
                          ...
                          return c
                            .then(function (e) {
                              ...
                              for (var n = 0; n < o.length; n++) {
                                var r = o[n];
                                (r._dbInfo.db = e), E(r._dbInfo);
                              }
                            })
                            .catch(function (n) {
                              throw (
                                ((N(e, n) || f.resolve()).catch(function () {}),
                                n)
                              );
                            });
                        }
                    ...
                    : i.then(function (n) {
                        ...
                        for (var o = 0; o < t.length; o++)
                          t[o]._dbInfo.db = null;
                        var i = new f(function (n, r) {
                          var t = a.deleteDatabase(e.name);
                          (t.onerror = function () {
                            var e = t.result;
                            e && e.close(), r(t.error);
                          }),
                        ...
                        return i
                          .then(function (e) {
                            r.db = e;
                            for (var n = 0; n < t.length; n++) E(t[n]._dbInfo);
                          })
                          .catch(function (n) {
                            throw (
                              ((N(e, n) || f.resolve()).catch(function () {}),
                ...
                } else t = f.reject("Invalid arguments");
                return s(t, n), t;
              }
              var X = {
              ...
              function ge(e) {
                ...
                return (r.serializer = be), o;
              }
              function _e(e, n, r, t, o, i) {
                e.executeSql(
                  r,
                  t,
                  o,
                    ...
                    .then(function () {
                      ...
                      o.db.transaction(function (r) {
                        _e(
                          ...
                          [e],
                          function (e, r) {
                            var t = r.rows.length ? r.rows.item(0).value : null;
                            t && (t = o.serializer.deserialize(t)), n(t);
                          },
                          function (e, n) {
                            t(n);
                          }
                      ...
                      .then(function () {
                        ...
                        o.db.transaction(function (r) {
                          _e(
                            ...
                            [e + 1],
                            function (e, r) {
                              var t = r.rows.length ? r.rows.item(0).key : null;
                              n(t);
                            },
                            function (e, n) {
                              t(n);
                      ...
                      .then(function () {
                        ...
                        t.db.transaction(function (n) {
                          _e(
                            ...
                            [],
                            function (n, r) {
                              for (var t = [], o = 0; o < r.rows.length; o++)
                                t.push(r.rows.item(o).key);
                              e(t);
                            },
                            function (e, n) {
                              r(n);
                  ...
                  e.transaction(
                    function (t) {
                      t.executeSql(
                        ...
                        [],
                        function (r, t) {
                          for (var o = [], i = 0; i < t.rows.length; i++)
                            o.push(t.rows.item(i).name);
                          n({ db: e, storeNames: o });
                        },
                        function (e, n) {
                          r(n);
              ...
              function Ce(e, n) {
                var r = e.name + "/";
                return (
                  e.storeName !== n.storeName && (r += e.storeName + "/"), r
                );
              }
              function Te() {
              ...
              function Le(e) {
                ...
                if (e) for (var t in e) r[t] = e[t];
                return (
                  (r.keyPrefix = Ce(e, n._defaultConfig)),
                  Fe()
                    ? ((n._dbInfo = r), (r.serializer = be), f.resolve())
                    : f.reject()
                );
              }
              function Me(e) {
                var n = this,
                  r = n.ready().then(function () {
                    for (
                      var e = n._dbInfo.keyPrefix, r = localStorage.length - 1;
                      r >= 0;
                      r--
                    ) {
              ...
              function ze(e, n) {
                ...
                var t = r.ready().then(function () {
                  var n = r._dbInfo,
                    t = localStorage.getItem(n.keyPrefix + e);
              ...
              function qe(e) {
                var n = this,
                  r = n.ready().then(function () {
                    for (
                      var e = n._dbInfo, r = localStorage.length, t = [], o = 0;
                      o < r;
                      o++
                    ) {
                      var i = localStorage.key(o);
                      0 === i.indexOf(e.keyPrefix) &&
                        t.push(i.substring(e.keyPrefix.length));
                    }
                    return t;
                  });
                return s(r, e), r;
              ...
              function He(e, n, r) {
                ...
                var o = t.ready().then(function () {
                  ...
                  return new f(function (o, i) {
                    var a = t._dbInfo;
                    a.serializer.serialize(n, function (n, t) {
                      if (t) i(t);
                      else
                        try {
              ...
              var Xe = {
                ...
                Ye = {},
                Ze = {},
                $e = { INDEXEDDB: X, WEBSQL: xe, LOCALSTORAGE: Xe },
                en = [
                  $e.INDEXEDDB._driver,
                  $e.WEBSQL._driver,
              ...
              var un = (function () {
                  function e(n) {
                    for (var r in (o(this, e), $e))
                      if ($e.hasOwnProperty(r)) {
                        var t = $e[r],
                          i = t._driver;
                        (this[r] = i), Ye[i] || this.defineDriver(t);
                      }
                    (this._defaultConfig = an({}, tn)),
                      (this._config = an({}, this._defaultConfig, n)),
                  ...
                  return (
                    ...
                    (e.prototype.defineDriver = function (e, n, r) {
                      var t = new f(function (n, r) {
                        try {
                          var t = e._driver,
                            o = new Error(
                          ...
                          var d = function (r) {
                            Ye[t] &&
                              console.info(
                                "Redefining LocalForage driver: " + t
                              ),
                              (Ye[t] = e),
                              (Ze[t] = r),
                              n();
                    ...
                    (e.prototype.getDriver = function (e, n, r) {
                      var t = Ye[e]
                        ? f.resolve(Ye[e])
                    ...
                    (e.prototype.setDriver = function (e, n, r) {
                      var t = this;
                      Ve(e) || (e = [e]);
                      ...
                      function u(e) {
                        return function () {
                          ...
                          function r() {
                            ...
                            return (t._driverSet = f.reject(u)), t._driverSet;
                          }
                          return r();
                        };
                      }
                      ...
                      return (
                        (this._driverSet = c
                          ...
                          .catch(function () {
                            ...
                            return (t._driverSet = f.reject(e)), t._driverSet;
                          })),
