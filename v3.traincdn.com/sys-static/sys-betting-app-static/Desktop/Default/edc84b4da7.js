...
function Be() {
    ...
    if (
      ...
      if (t.slidesPerView === "auto") {
        ...
        if (
          ...
          I = i.isHorizontal() ? oe(E, "width") : oe(E, "height");
        else {
          const L = e(M, "width"),
            k = e(M, "padding-left"),
            we = e(M, "padding-right"),
            te = e(M, "margin-left"),
            ie = e(M, "margin-right"),
            se = M.getPropertyValue("box-sizing");
          if (se && se === "border-box") I = L + te + ie;
          else {
            const { clientWidth: Se, offsetWidth: Te } = E;
            I = L + k + we + te + ie + (Te - Se);
          }
        }
        ...
        (I = (r - (t.slidesPerView - 1) * h) / t.slidesPerView),
          t.roundLengths && (I = Math.floor(I)),
  ...
  if (
    ((i.virtualSize = Math.max(i.virtualSize, r) + y),
    l &&
      a &&
  ...
  if (o && t.loop) {
    ...
    if (t.slidesPerGroup > 1) {
      ...
      for (let x = 0; x < E; x += 1) p.push(p[p.length - 1] + M);
    }
  ...
  for (let o = 0; o < s.length; o += 1) {
    ...
    const f =
      ...
      y =
        ...
        (m > 1 && m <= e.size) ||
        (u <= 0 && m >= e.size);
    y && (e.visibleSlides.push(d), e.visibleSlidesIndexes.push(o)),
      ae(d, y, t.slideVisibleClass),
      ae(d, g, t.slideFullyVisibleClass),
      (d.progress = n ? -f : f),
...
function He() {
  ...
  o &&
    (l ||
      ((c = Ce(o, `.${t.slideClass}, swiper-slide`)[0]),
      t.loop && !c && (c = e[0]),
      (d = Ie(o, `.${t.slideClass}, swiper-slide`)[0]),
      t.loop && !d === 0 && (d = e[e.length - 1]))),
    e.forEach((f) => {
      X(f, f === o, t.slideActiveClass),
        X(f, f === c, t.slideNextClass),
        X(f, f === d, t.slidePrevClass);
    }),
    i.emitSlidesClasses();
}
const $ = (i, e) => {
...
function je(i) {
  ...
  if ((typeof o == "undefined" && (o = We(e)), s.indexOf(t) >= 0))
    d = s.indexOf(t);
  else {
  ...
  if (
    ...
    if (e === 0) a[f ? "scrollLeft" : "scrollTop"] = -c;
      ...
      if (!r.support.smoothScroll)
        return (
          pe({ swiper: r, targetPosition: -c, side: f ? "left" : "top" }), !0
        );
...
function tt(i, e) {
  ...
  s.cssMode ||
    ...
    ge({ swiper: t, runCallbacks: i, direction: e, step: "Start" }));
}
function it(i, e) {
  i === void 0 && (i = !0);
  const t = this,
  ...
  (t.animating = !1),
    !s.cssMode &&
      (t.setTransition(0),
      ge({ swiper: t, runCallbacks: i, direction: e, step: "End" }));
}
...
function rt(i, e, t, s, n) {
  ...
  if (a.cssMode) {
    ...
    if (e === 0) {
      ...
      if (!r.support.smoothScroll)
        return (
          pe({ swiper: r, targetPosition: T, side: h ? "left" : "top" }), !0
        );
...
function pt(i) {
  ...
  if (
    ...
    u.slidesPerView === "auto"
      ? o.updateSlides()
      : b &&
        ((h.length > 0 && V) || (T.length > 0 && C)) &&
        o.slides.forEach((x, P) => {
          o.grid.updateSlide(P, x, o.slides);
        }),
    ...
    if (h.length > 0 && V) {
      ...
      if (typeof e == "undefined") {
        ...
        const x = b ? T.length / u.grid.rows : T.length;
        o.slideTo(o.activeIndex - x, 0, !1, !0);
      }
  }
  if (
...
function Tt(i) {
  ...
  if (r.noSwiping && (p ? St(f, o) : o.closest(f))) {
    e.allowClick = !0;
    return;
  }
...
function yt(i) {
  ...
  for (
    ...
    typeof d[S + C] != "undefined"
      ? (m || (u >= d[S] && u < d[S + C])) && ((g = S), (y = d[S + C] - d[S]))
      : (m || u >= d[S]) && ((g = S), (y = d[d.length - 1] - d[d.length - 2]));
  }
  let v = null,
    b = null;
  l.rewind &&
...
function It() {
  const i = this,
    { params: e } = i;
  (i.onTouchStart = Tt.bind(i)),
    (i.onTouchMove = xt.bind(i)),
    (i.onTouchEnd = yt.bind(i)),
    (i.onDocumentTouchStart = Pt.bind(i)),
    e.cssMode && (i.onScroll = Et.bind(i)),
    (i.onClick = bt.bind(i)),
    (i.onLoad = Mt.bind(i)),
    ve(i, "on");
}
...
export {
  A as Swiper,
  ye as classesToTokens,
  Q as createElement,
  fe as defaults,
  G as elementChildren,
  ne as elementIndex,
  Nt as elementOffset,
  oe as elementOuterSize,
  Le as elementParents,
  F as getDocument,
  $t as makeElementsArray,
  J as nextTick,
};
