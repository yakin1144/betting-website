...
function x(e) {
  ...
  for (
    var t = S(10) ? document.body : null, r = e.offsetParent || null;
...
function D(e, t) {
  ...
  if ((e !== f && t !== f) || n.contains(o)) return ge(f) ? f : x(f);
  var s = R(e);
  return s.host ? D(s.host, t) : D(e, R(t).host);
}
function P(e) {
  var t =
...
function J(e) {
  var t = e.body,
    r = e.documentElement,
    n = S(10) && getComputedStyle(r);
  return { height: _("Height", t, r, n), width: _("Width", t, r, n) };
}
var we = function (e, t) {
    if (!(e instanceof t))
...
function Q(e) {
  ...
  if (O(e, "position") === "fixed") return !0;
  var r = I(e);
  return r ? Q(r) : !1;
}
function Z(e) {
...
function ee(e, t, r, n, o) {
  ...
  var f = V(r, n, i, o),
    ...
    a = Object.keys(s)
      .map(function (d) {
        return g({ key: d }, s[d], { area: Oe(s[d]) });
      })
      .sort(function (d, c) {
...
function ie(e, t, r) {
  var n = r === void 0 ? e : e.slice(0, xe(e, "name", r));
  return (
...
function se(e, t, r, n) {
  ...
  i.addEventListener(t, r, { passive: !0 }),
    o || se(C(i.parentNode), t, r, n),
    n.push(i);
}
function Se(e, t, r, n) {
  (r.updateBound = n),
    fe(e).addEventListener("resize", r.updateBound, { passive: !0 });
  var o = C(e);
  return (
    se(o, "scroll", r.updateBound, r.scrollParents),
    (r.scrollElement = o),
    (r.eventsEnabled = !0),
    r
  );
...
function Me() {
  this.state.eventsEnabled &&
    ...
    (this.state = Ce(this.reference, this.state)));
}
function U(e) {
...
function Be(e, t, r, n, o) {
  ...
  return (
    ...
    H(t, { position: r.positionFixed ? "fixed" : "absolute" }),
    r
  );
}
function Fe(e, t) {
...
function Re(e, t) {
  ...
  var f = i !== void 0 ? i : t.gpuAcceleration,
    s = x(e.instance.popper),
    a = W(s),
    l = { position: o.position },
    p = Fe(e, window.devicePixelRatio < 2 || !Ae),
...
function We(e, t) {
  ...
  var o = e.placement.split("-")[0],
    ...
    c = a ? "bottom" : "right",
    h = re(n)[l];
  s[c] - h < f[u] && (e.offsets.popper[u] -= f[u] - (s[c] - h)),
    s[u] + h > f[c] && (e.offsets.popper[u] += s[u] + h - f[c]),
  ...
  return (
    (E = Math.max(Math.min(f[l] - h, E), 0)),
    (e.arrowElement = n),
    (e.offsets.arrow = ((r = {}), L(r, u, Math.round(E)), L(r, d, ""), r)),
    e
  );
}
function He(e) {
...
function Ie(e, t) {
  ...
  return (
    f.forEach(function (s, a) {
      if (n !== s || f.length === a + 1) return e;
      (n = e.placement.split("-")[0]), (o = N(n));
      var l = e.offsets.popper,
        p = e.offsets.reference,
        u = Math.floor,
        d =
          (n === "left" && u(l.right) > u(p.left)) ||
          (n === "right" && u(l.left) < u(p.right)) ||
          (n === "top" && u(l.bottom) > u(p.top)) ||
          (n === "bottom" && u(l.top) < u(p.bottom)),
        c = u(l.left) < u(r.left),
      ...
      (d || w || j) &&
        ...
        (e.offsets.popper = g(
          {},
          e.offsets.popper,
          ne(e.instance.popper, e.offsets.reference, e.placement)
        )),
...
function ke(e) {
  var t = e.offsets,
    ...
    i = Math.floor,
    f = ["top", "bottom"].indexOf(o) !== -1,
    s = f ? "right" : "bottom",
    a = f ? "left" : "top",
    l = f ? "width" : "height";
  return (
    r[s] < i(n[a]) && (e.offsets.popper[a] = i(n[a]) - r[l]),
    r[a] > i(n[s]) && (e.offsets.popper[a] = i(n[s])),
    e
  );
}
function Ve(e, t, r, n) {
...
function $e(e, t, r, n) {
  ...
  return (
    (l = l.map(function (p, u) {
      ...
      return p
        .reduce(function (h, v) {
          return h[h.length - 1] === "" && ["+", "-"].indexOf(v) !== -1
            ? ((h[h.length - 1] = v), (c = !0), h)
            : c
            ? ((h[h.length - 1] += v), (c = !1), h)
            : h.concat(v);
        }, [])
        .map(function (h) {
          return Ve(h, d, t, r);
  ...
  var l = t.priority,
    ...
    u = {
      primary: function (c) {
        var h = p[c];
        return (
          p[c] < a[c] && !t.escapeWithReference && (h = Math.max(p[c], a[c])),
          L({}, c, h)
        );
      },
...
function ze(e) {
  ...
  if (n) {
    var o = e.offsets,
      ...
      a = s ? "left" : "top",
      l = s ? "width" : "height",
      p = { start: L({}, a, i[a]), end: L({}, a, i[a] + i[l] - f[l]) };
...
function qe(e) {
  ...
  return (
    (o[f ? "left" : "top"] = i[r] - (s ? o[f ? "width" : "height"] : 0)),
    (e.placement = N(t)),
...
var _e = {
    shift: { order: 100, enabled: !0, fn: ze },
    ...
    keepTogether: { order: 400, enabled: !0, fn: ke },
    arrow: { order: 500, enabled: !0, fn: We, element: "[x-arrow]" },
    flip: {
      order: 600,
      enabled: !0,
      fn: Ie,
    ...
    inner: { order: 700, enabled: !1, fn: qe },
    hide: { order: 800, enabled: !0, fn: Ye },
    computeStyle: {
      order: 850,
      enabled: !0,
      fn: Re,
  ...
  B = (function () {
    function e(t, r) {
      ...
      we(this, e),
        ...
        Object.keys(g({}, e.Defaults.modifiers, o.modifiers)).forEach(function (
          f
        ) {
          n.options.modifiers[f] = g(
            {},
            e.Defaults.modifiers[f] || {},
            o.modifiers ? o.modifiers[f] : {}
          );
        }),
        (this.modifiers = Object.keys(this.options.modifiers)
          .map(function (f) {
            return g({ name: f }, n.options.modifiers[f]);
          })
          .sort(function (f, s) {
        ...
        this.modifiers.forEach(function (f) {
          f.enabled &&
            K(f.onLoad) &&
            f.onLoad(n.reference, n.popper, n.options, f, n.state);
        }),
        this.update();
